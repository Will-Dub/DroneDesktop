...
Item {
    ...
    Pane{
        ...
        Map {
            ...
            anchors.fill: parent
            plugin: mapPlugin
            center: QtPositioning.coordinate(45.5, -73.5)
            zoomLevel: 13
            ...
            MapQuickItem {
                id: currentPoint
                coordinate: QtPositioning.coordinate(45.5017, -73.5673)
                anchorPoint.x: currentMarker.width / 2
                anchorPoint.y: currentMarker.height
            ...
            MapQuickItem {
                id: dronePoint
                coordinate: QtPositioning.coordinate(45.6017, -73.5673)
